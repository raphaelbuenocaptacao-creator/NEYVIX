...
['docs detects schema readiness on operational failure',/inspectDriveDocsRepair/.test(files.api)&&/readiness\.docs !== "ready"/.test(files.api)],
['docs exposes stable schema-not-ready code',/SCHEMA_NOT_READY/.test(files.api)&&/module: "docs"/.test(files.api)],
['docs degraded response remains private and retryable',/Retry-After/.test(files.api)&&/status: 503/.test(files.api)],
['docs distinguishes generic service outage',/SERVICE_UNAVAILABLE/.test(files.api)],
