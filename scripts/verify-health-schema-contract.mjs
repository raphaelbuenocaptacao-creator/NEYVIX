...
const checks = [
  ...
  ["health exposes Drive schema status", /drive: "ready" \| "missing" \| "unknown"/.test(health)],
  ...
  ["health computes Drive readiness", /const driveReady = Boolean\(catalog\.drive_items_table\)/.test(health)],
