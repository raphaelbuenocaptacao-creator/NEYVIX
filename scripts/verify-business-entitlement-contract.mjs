...
assertIncludes('if (status === "active" || status === "lifetime")', "paid entitlements must require an explicitly allowed active or lifetime status");
...
console.log("PASS: Business positive entitlement contract is explicit, database-backed, and isolated from trial/expired access, including explicit lifetime subscriptions.");
