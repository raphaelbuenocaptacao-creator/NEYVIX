...
const modules = [
  ...
  { name: "NEYVIX Drive", status: "Funcional", detail: "Pastas e arquivos privados persistidos com upload, download, navegação, renomeação e exclusão segura.", href: "/drive" },
