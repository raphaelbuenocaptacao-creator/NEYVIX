...
const SMOKE_EMAIL_RE = /^(?:e2e-smoke|e2e-ai-mem|e2e-ai-hist|e2e-memory|e2e-chat|e2e-deploy|business-negative|business-positive|mail-access)-[a-z0-9-]+@neyvix\.com$/i;
